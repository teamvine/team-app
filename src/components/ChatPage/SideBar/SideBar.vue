  ...
  <div class="side-bar-view">
    <div class="sidebar-view" v-if="show_nav">
        <div class="my-auto">
          ...
          <div class="text-center icon-div icon-dash" @click="$router.push({name: 'StartPage'})">
            <img src="../../../assets/svgs/home.svg" class="svg" alt=""/>
          </div>
          <div class="text-center icon-div icon-msg active">
            <img src="../../../assets/svgs/chat.svg" class="svg" alt=""/>
          </div>
          <div class="text-center icon-div icon-team">
            <img src="../../../assets/svgs/group.png" class="svg" alt=""/>
          </div>
          ...
          <div class="text-center icon-div icon-setting" @click="$router.push({name: 'SettingsPage'})">
            <img src="../../../assets/svgs/settings.svg" class="svg" alt=""/>
          </div>
        </div>
    </div>
