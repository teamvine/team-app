<template>
    <main class="flex-1 ">
        <div class="w-full flex-row flex content-center justify-center flex-wrap py-3 px-2">
            <div class="pb-4 border-t border-gray-200 w-full content-center justify-center flex-wrap sm:w-3/4 md:w-3/6 lg:w-3/6 md:shadow-md border rounded-sm mt-3 mb-4">
                    ...
                    <div class="px-8 pt-6 pb-2 mb-2 flex flex-col my-2 w-3/4 mx-auto">
                      <div class="-mx-3 md:flex mb-0">
                        <div class="flex flex-wrap items-stretch w-full mb-4 relative Lato__Bold">
                          ...
                          <input v-model="searchText" @keyup="searchOrganizations" type="search" class="flex-shrink flex-grow flex-auto py-3 leading-normal w-px flex-1 border border-l-0 border-grey-light rounded-l-none rounded-r-none px-3 relative" placeholder="Search text...">
                          <div class="flex -mr-px">
                            <button @click="searchOrganizations" @dblclick="searchOrganizations" type="button" class="flex items-center leading-normal border-none rounded rounded-l-none border border-l-0 py-3 border-grey-light px-3 whitespace-no-wrap text-md btn-blue text-white">Search</button>
                          </div>
