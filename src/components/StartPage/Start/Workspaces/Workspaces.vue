<template>
    <main class="flex-1 ">
        <div class="w-full flex-row flex content-center justify-center flex-wrap py-3">
            <div class="w-full content-center justify-center flex-wrap p-2 px-0 pt-0 sm:w-3/4 md:w-3/4 lg:w-4/6 border border-gray-500 rounded-sm md:rounded-md mt-3 mb-4">
