  ...
  <div class="my-account p-0">
    ...
    <div class="text-center my-- border-b-2 border-gray-400 pb-5">
      <img
        ...
        alt="profile img"
      />
      <p class="text-center text-lg font-bold mt-4 font-arial">
        Jane Doe Hamblin
      </p>
    ...
    <div class="grid grid-cols-2 py-2 bg-white">
      <div class="text-left my-auto">
        <span class="text-blue-600 text-md font-bold font-arial px-5"
          >Home</span
        >
        <span class="text-gray-800 text-md font-bold font-arial px-5"
          >About</span
        >
        <span class="text-gray-800 text-md font-bold font-arial px-5"
          >Workspace</span
