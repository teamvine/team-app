module.exports = {
    baseURL: "http://192.168.0.250:3000", //api server base url (NodeJs)
    messagesServer: "http://192.168.0.250:3002", //socket server url (NodeJs)
    ...
    filesBaseUrl: "http://192.168.0.250:3001", // files server (Django)
    loginAPI: {
